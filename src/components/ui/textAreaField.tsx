...
export const TextAreaField: React.FC<TextAreaFieldProps> = ({label, name, defaultValue, register, errors, className, placeholder }) => {
    return <div className="mb-4">
        ...
        <textarea {...register(name)} defaultValue={defaultValue} className={`w-full text-gray-300 placeholder:text-gray-400 mt-1 p-2 border border-gray-500 rounded-md ${className}`} placeholder={placeholder} rows={2}></textarea>
